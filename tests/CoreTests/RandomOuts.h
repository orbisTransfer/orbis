...
private:
  ...
  bool checkHalfUnlocked(Orbis::core& c, size_t ev_index, const std::vector<test_event_entry>& events);
  bool checkFullyUnlocked(Orbis::core& c, size_t ev_index, const std::vector<test_event_entry>& events);

  bool request(Orbis::core& c, uint64_t amount, size_t mixin, Orbis::COMMAND_RPC_GET_RANDOM_OUTPUTS_FOR_AMOUNTS_response& resp);
