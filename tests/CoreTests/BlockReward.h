...
struct gen_block_reward : public test_chain_unit_base
{
  ...
  bool mark_checked_block(Orbis::core& c, size_t ev_index, const std::vector<test_event_entry>& events);
  bool check_block_rewards(Orbis::core& c, size_t ev_index, const std::vector<test_event_entry>& events);
