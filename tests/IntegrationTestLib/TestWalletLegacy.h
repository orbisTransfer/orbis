...
class TestWalletLegacy : private Orbis::IWalletLegacyObserver {
public:
  TestWalletLegacy(System::Dispatcher& dispatcher, const Orbis::Currency& currency, Orbis::INode& node);
  ~TestWalletLegacy();
  ...
  Orbis::IWalletLegacy* wallet();
  Orbis::AccountPublicAddress address() const;
...
private:
  ...
  std::unique_ptr<Orbis::IWalletLegacyObserver> m_walletObserver;
