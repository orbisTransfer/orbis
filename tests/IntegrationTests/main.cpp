...
public:
  ...
  SimpleTest(const Orbis::Currency& currency, System::Dispatcher& system, const Tests::Common::BaseFunctionalTestsConfig& config) : 
    BaseFunctionalTests(currency, system, config) {}

  class WaitForActualGrowObserver : public Orbis::IWalletLegacyObserver {
  ...
  class WaitForActualDwindleObserver : public Orbis::IWalletLegacyObserver {
    Tests::Common::Semaphore& m_GotActual;
  ...
  class WaitForPendingGrowObserver : public Orbis::IWalletLegacyObserver {
    Tests::Common::Semaphore& m_GotActual;
  ...
  class WaitForConfirmationObserver : public Orbis::IWalletLegacyObserver {
  ...
  class WaitForSendCompletedObserver : public Orbis::IWalletLegacyObserver {
    Tests::Common::Semaphore& m_Sent;
    std::error_code& m_error;
    Orbis::TransactionId& m_transactionId;

  public:
    WaitForSendCompletedObserver(Tests::Common::Semaphore& Sent, Orbis::TransactionId& transactionId, std::error_code& error) : m_Sent(Sent), m_transactionId(transactionId), m_error(error) { }
  ...
  class WaitForExternalTransactionObserver : public Orbis::IWalletLegacyObserver {
  public:
    WaitForExternalTransactionObserver() { }
    std::promise<Orbis::TransactionId> promise;
  ...
  class WaitForTransactionUpdated : public Orbis::IWalletLegacyObserver {
  public:
    ...
    Orbis::TransactionId expectindTxId;
  };
  ...
  bool perform1() {
    ...
    std::unique_ptr<Orbis::IWalletLegacy> wallet1;
    std::unique_ptr<Orbis::IWalletLegacy> wallet2;
  ...
  class WaitForBlockchainHeightChangeObserver : public Orbis::INodeObserver {
  ...
  class CallbackHeightChangeObserver : public Orbis::INodeObserver {
  ...
  bool perform2(size_t blocksCount = 10)
  {
    ...
    mineBlock();
    LOG_TRACE("STEP 2 PASSED");
    std::unique_ptr<Orbis::INode> localNode;
    std::unique_ptr<Orbis::INode> remoteNode;
  ...
  bool perform4() {
    ...
    std::unique_ptr<Orbis::INode> hopNode;
    std::unique_ptr<Orbis::INode> localNode;
    std::unique_ptr<Orbis::INode> remoteNode;
  ...
  bool perform5() {
    ...
    std::unique_ptr<Orbis::INode> node1;
    std::unique_ptr<Orbis::INode> inprocNode;
...
void testMultiVersion(const Orbis::Currency& currency, System::Dispatcher& d, const Tests::Common::BaseFunctionalTestsConfig& config);
...
public:
  ...
  SimpleTestCase() : 
    currency(Orbis::CurrencyBuilder(logger).testnet(true).currency()), 
...
TEST_F(SimpleTestCase, TESTPOOLDELETION) {
  currency = Orbis::CurrencyBuilder(logger).testnet(true).mempoolTxLiveTime(60).currency();
