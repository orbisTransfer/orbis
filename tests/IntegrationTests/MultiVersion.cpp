...
public:
  ...
  MultiVersionTest(const Orbis::Currency& currency, System::Dispatcher& d, const Tests::Common::BaseFunctionalTestsConfig& config, Logging::ILogger& log) :
  ...
  void run() {
    ...
    Orbis::AccountBase stashAddress;
