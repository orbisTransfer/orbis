...
const char* getStatusString(Orbis::HttpResponse::HTTP_STATUS status) {
  switch (status) {
  case Orbis::HttpResponse::STATUS_200:
    return "200 OK";
  case Orbis::HttpResponse::STATUS_404:
    return "404 Not Found";
  case Orbis::HttpResponse::STATUS_500:
...
const char* getErrorBody(Orbis::HttpResponse::HTTP_STATUS status) {
  switch (status) {
  case Orbis::HttpResponse::STATUS_404:
...
HttpResponse::HttpResponse() {
  status = STATUS_200;
  headers["Server"] = "Orbis-based HTTP server";
}
