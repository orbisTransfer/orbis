...
TransfersSyncronizer::TransfersSyncronizer(const Orbis::Currency& currency, IBlockchainSynchronizer& sync, INode& node) :
...
void TransfersSyncronizer::save(std::ostream& os) {
  ...
  Orbis::BinaryOutputStreamSerializer s(stream);
...
void TransfersSyncronizer::load(std::istream& is) {
  ...
  Orbis::BinaryInputStreamSerializer s(inputStream);
  uint32_t version = 0;
