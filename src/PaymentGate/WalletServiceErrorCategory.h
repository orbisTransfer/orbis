...
inline std::error_code make_error_code(Orbis::error::WalletServiceErrorCode e) {
  return std::error_code(static_cast<int>(e), Orbis::error::WalletServiceErrorCategory::INSTANCE);
}

namespace std {

template <>
struct is_error_code_enum<Orbis::error::WalletServiceErrorCode>: public true_type {};
