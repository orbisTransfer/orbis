...
#include "OrbisCore/BlockIndex.h"
#include "OrbisCore/Checkpoints.h"
#include "OrbisCore/Currency.h"
#include "OrbisCore/IBlockchainStorageObserver.h"
#include "OrbisCore/ITransactionValidator.h"
#include "OrbisCore/SwappedVector.h"
...
namespace Orbis {
  ...
  class Blockchain : public Orbis::ITransactionValidator {
  public:
    ...
    bool handleGetObjects(NOTIFY_REQUEST_GET_OBJECTS_request& arg, NOTIFY_RESPONSE_GET_OBJECTS_request& rsp); //Deprecated. Should be removed with OrbisProtocolHandler.
