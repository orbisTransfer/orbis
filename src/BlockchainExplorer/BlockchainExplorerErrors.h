...
inline std::error_code make_error_code(Orbis::error::BlockchainExplorerErrorCodes e) {
  return std::error_code(static_cast<int>(e), Orbis::error::BlockchainExplorerErrorCategory::INSTANCE);
}
