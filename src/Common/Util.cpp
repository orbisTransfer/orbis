...
std::string get_nix_version_display_string()
{
  ...
  {
    //namespace fs = boost::filesystem;
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\ORBIS_NAME
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\ORBIS_NAME
    // Mac: ~/Library/Application Support/ORBIS_NAME
    // Unix: ~/.ORBIS_NAME
    std::string config_folder;
#ifdef WIN32
    // Windows
    config_folder = get_special_folder_path(CSIDL_APPDATA, true) + "/" + Orbis::ORBIS_NAME;
#else
    std::string pathRet;
    ...
    config_folder =  (pathRet + "/" + Orbis::ORBIS_NAME);
#else
    // Unix
    config_folder = (pathRet + "/." + Orbis::ORBIS_NAME);
#endif
