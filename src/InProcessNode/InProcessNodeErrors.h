...
inline std::error_code make_error_code(Orbis::error::InProcessNodeErrorCodes e) {
  return std::error_code(static_cast<int>(e), Orbis::error::InProcessNodeErrorCategory::INSTANCE);
}
